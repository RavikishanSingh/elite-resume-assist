      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Create professional, ATS-friendly resumes in minutes. Import directly from LinkedIn or build from scratch with AI-powered feedback.
          </p>
          ...
          {/* Feature highlight for LinkedIn import */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
            <div className="flex items-center justify-center space-x-2 mb-3">
              <svg className="w-6 h-6 text-blue-600" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
              <h3 className="text-lg font-semibold text-blue-900">LinkedIn Integration Now Available!</h3>
            </div>
            <p className="text-blue-800 text-center">
              Import your professional profile directly from LinkedIn in seconds. Try our demo with sample profiles or connect your own!
            </p>
          </div>
        </div>
      </section>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-gray-600">
                  Import your professional information directly from LinkedIn with intelligent data extraction and formatting.
                </CardDescription>
              </CardHeader>
            </Card>
      ...
      <section className="container mx-auto px-4 py-20 bg-white/50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Skip the Manual Work - Import from LinkedIn
          </h2>
          <p className="text-xl text-gray-600 mb-8">
            Save hours of typing. Connect your LinkedIn profile and automatically populate your resume with your professional information.
          </p>
          
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-lg font-semibold mb-4 text-gray-900">Traditional Way</h3>
            ...
            <div className="bg-blue-50 p-6 rounded-lg shadow-lg border-2 border-blue-200">
              <h3 className="text-lg font-semibold mb-4 text-blue-900">With LinkedIn Import</h3>
